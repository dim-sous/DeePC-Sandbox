"""Plotting utilities for DeePC results."""
...
def plot_all(
    ...
    """Generate combined figure (2x2 layout).
...
def _plot_impl(results: dict, config: DeePCConfig, save_dir: str, tag: str) -> None:
    ...
    fig.suptitle(f"{tag} — DeePC Trajectory Tracking", fontsize=13, fontweight="bold", y=0.97)
