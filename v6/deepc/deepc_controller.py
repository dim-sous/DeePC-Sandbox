"""Data-Enabled Predictive Controller (DeePC) — v6.

Online sliding Hankel window per arXiv:2407.16066. Builds on v5's
...
class DeePCController:
    """Receding-horizon DeePC controller (v6) — online sliding Hankel."""
    ...
    def _build_optimization_problem(self) -> None:
        ...
        # Noise-adaptive parameters (from v5)
        ...
        # Hankel matrices as CVXPY Parameters (THE v6 change)
    ...
    def update_robustness(
        ...
        """Update noise-adaptive regularization (from v5)."""
