"""v2 — DeePC with complete constraint structure.

Adds input rate constraints, soft output constraints, and configurable
L1/L2 regularization to the v1 baseline formulation.

Usage (from repo root):
    uv run python -m v2.main
"""
